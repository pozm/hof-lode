...
use sqlx::{FromRow, query, query_as, SqlitePool};
...
pub async fn fetch_new_data() -> reqwest::Result<json::Root> {
    let the_data = reqwest::get("https://xivapi.com/freecompany/9235053248388316377?data=FCM").await?.json::<json::Root>().await?;
